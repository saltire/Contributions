...
while($row = @pg_fetch_assoc($result)) {
	...
	if ($tablename == "contribassociations") $url = "http://www.elections.ca/scripts/webpep/fin2/contributor.aspx?type=1&client=$idClient&row=$idRow&seqno=&part=2a&entity=5&lang=e&option=4&return=1";
	else if ($tablename == "contribparties") $url = "http://www.elections.ca/scripts/webpep/fin2/contributor.aspx?type=1&client=$idClient&row=$idRow&part=2a&entity=6&lang=e&option=4&period=0";
	else if ($tablename == "contribelections") $url = "http://www.elections.ca/scripts/webpep/fin2/contributor.aspx?type=1&client=$idClient&row=$idRow&part=2a&entity=1&lang=e&option=4&period=1";
	else exit();
	echo($url);
